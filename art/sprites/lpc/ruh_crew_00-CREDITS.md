...
### Page (hair.page)
- **File:** hair/page
- **Authors:** Page, Johannes Sjölund (wulax)
- **Licenses:** OGA-BY 3.0, CC-BY-SA 3.0, GPL 3.0
- **URLs:** https://opengameart.org/content/lpc-medieval-fantasy-character-sprites, https://opengameart.org/content/lpc-expanded-hair
...
- **Authors:** bluecarrot16, JaidynReiman, Matthew Krohn (makrohn), Marcel van de Steeg (MadMarcel), Stephen Challener (Redshrike), Johannes Sjölund (wulax)
- **Licenses:** OGA-BY 3.0, CC-BY-SA 3.0, GPL 3.0
- **URLs:** https://opengameart.org/content/lpc-female-orcogregoblintroll-base-walkcycle, https://opengameart.org/content/lpc-curly-hair-elven-ears-white-cape-with-blue-trim-and-more, http://opengameart.org/content/lpc-clothing-updates
